...
partial class EntityTypeConfigurationEntityTypeAttributeConvention<T> : EntityTypeAttributeConventionBase<EntityTypeConfigurationAttribute<T>>
{
    ...
    public EntityTypeConfigurationEntityTypeAttributeConvention(ProviderConventionSetBuilderDependencies dependencies) : base(dependencies)
    {
    }
    ...
    protected override void ProcessEntityTypeAdded(
        ...
        EntityTypeConfigurationAttribute<T> attribute,
