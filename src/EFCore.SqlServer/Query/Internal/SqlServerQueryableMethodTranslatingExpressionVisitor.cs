    ...
    public class SqlServerQueryableMethodTranslatingExpressionVisitor : RelationalQueryableMethodTranslatingExpressionVisitor
    {
        ...
        protected override Expression VisitExtension(Expression extensionExpression)
        {
            if (extensionExpression is TemporalQueryRootExpression temporalQueryRootExpression)
            {
                ...
                var temporalTableExpression = temporalQueryRootExpression.TemporalOperationType switch
                {
                    TemporalOperationType.All => new TemporalTableExpression(table),
                    TemporalOperationType.AsOf => new TemporalTableExpression(table, temporalQueryRootExpression.PointInTime!.Value),
                    _ => new TemporalTableExpression(
                        table,
                        temporalQueryRootExpression.From!.Value,
                        temporalQueryRootExpression.To!.Value,
                        temporalQueryRootExpression.TemporalOperationType),
                };
